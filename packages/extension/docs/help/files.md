...
The Files view is a file browser for an agent's virtual filesystem. Agents read and write files here to remember things, store instructions, and track tasks. This is how agents persist knowledge across conversations and sessions.
