...
**Note (audited 2026-04-11):** Smart Start logic is referenced in `background.ts`, `app.ts`, and `global-settings-view.ts`. The dashboard view does NOT reference Smart Start directly -- it generates its own AI suggestions independently.
